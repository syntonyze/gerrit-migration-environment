...
6. Allow users to login with mixed case usernames without the risk to create duplicate accounts:
```shell
...
This output shows the schema upgrade from `XXX` to `YYY`.
...
* Indexes will be migrated from XXXXX:
