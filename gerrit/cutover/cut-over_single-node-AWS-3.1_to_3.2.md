Cut over plan: migration from Gerrit version 3.1.15 to 3.2.12
==
...
4. Upgrade plugins and war file on gerrit:
    - Gerrit 3.2.12 war file can be found in
      the [Gerrit Code Review 3.2 official website](https://gerrit-releases.storage.googleapis.com/gerrit-3.2.12.war)
