...
===
 ...
 Consider upgrading a portion of
the cluster (i.e.: 50%) and leave an observation period (1 week?) with the .
This will allow to spot issues with the new release with a minor impact on the production traffic.
