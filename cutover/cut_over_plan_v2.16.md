...
10. Restart gerrit-2
11. Wait for the online reindexing of accounts and changes to finish (this step will need to be carefully timed during the staging environment migration)
